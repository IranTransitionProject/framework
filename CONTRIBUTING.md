...
the project's ability to offer alternative licensing to policy institutions and
governments that cannot accept copyleft terms, while keeping the public license
...
**Factional neutrality:**
The test for any claim is: *what must be true regardless of who governs?*
Analysis that depends on a preferred faction winning is not neutral analysis.
